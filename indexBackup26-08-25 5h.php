...
<body>
    ...
    <script>
        ...
        $('#btnMarcador').on('click', function() {
            ...
            const quadraSelecionada = $('.opcao-lote.selected').data('quadra');
            
            console.log('Botão Marcador clicado!');
            console.log('Lote atual:', loteAtual);
            console.log('Quadra selecionada:', quadraSelecionada);
            
            // Aqui você pode implementar a funcionalidade que quiser para o botão Marcador
            // Por exemplo: adicionar um marcador no mapa, salvar dados, etc.
        });
