            ...
            success: (response) => {
                ...
                try {
                    ...
                    if (resultado.status === 'sucesso') {
                        ...
                        // Para lotes, não precisa abrir o modal, então não chama fecharModalCamada()
                        if (this.desenho.tipoAtual !== 'polilinha') {
                            this.fecharModalCamada();
                        }

                        // Finaliza o modo de desenho para lotes
                        if (this.desenho.tipoAtual === 'polilinha') {
