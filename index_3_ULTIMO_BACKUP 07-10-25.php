...
<body>
    ...
    <div class="divContainerMap">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <button id="btnVoltar" onclick="irVoltar()" class="btn btn-light">Voltar</button>
                <!-- Título -->
                <a id="titleNavbar" class="navbar-brand" href="#">Plataforma Geo</a>
                ...
                <div class="d-flex align-items-center flex-grow-1 gap-2">
                    ...
                    <button id="btnConsulta" onclick="irConsulta()" class="btn btn-warning">Consultas</button>

                    <!-- Botão Cadastro removido - agora é uma camada no dropdown -->
    ...
    <script>
        ...
        if(dadosOrto[0]['quadricula'] != "" || dadosOrto[0]['quadricula'] != null){
            $('#titleNavbar').text(`Quadrícula ${dadosOrto[0]['quadricula']}`);
        }
